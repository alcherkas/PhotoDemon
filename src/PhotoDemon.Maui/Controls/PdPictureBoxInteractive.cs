...
/// <summary>
/// PhotoDemon interactive picture box control - migrated from VB6 pdPictureBoxInteractive.ctl
///
/// Features:
...
///
/// This control is designed for interactive UI elements that don't warrant a dedicated
/// user control. The owner must manually handle input and backbuffer rendering.
///
/// Original VB6: Controls/pdPictureBoxInteractive.ctl
/// Documentation: docs/ui/control-mapping.md
/// </summary>
public class PdPictureBoxInteractive : PhotoDemonControlBase
{
    #region Events
    ...
    /// <summary>
    /// Raised when mouse button is pressed down
    /// </summary>
    public event EventHandler<PointerEventArgs>? MouseDownCustom;

    /// <summary>
    /// Raised when mouse button is released
    /// </summary>
    public event EventHandler<PointerEventArgs>? MouseUpCustom;

    /// <summary>
    /// Raised when mouse moves over the control
    /// </summary>
    public event EventHandler<PointerEventArgs>? MouseMoveCustom;

    /// <summary>
    /// Raised when mouse enters the control
    /// </summary>
    public event EventHandler<PointerEventArgs>? MouseEnterCustom;

    /// <summary>
    /// Raised when mouse leaves the control
    /// </summary>
    public event EventHandler<PointerEventArgs>? MouseLeaveCustom;
    ...
    public static readonly BindableProperty BorderColorProperty = BindableProperty.Create(
        nameof(BorderColor),
        typeof(Color),
        typeof(PdPictureBoxInteractive),
        Colors.Gray,
    ...
    public PdPictureBoxInteractive()
    {
        // Interactive - can receive mouse events
    ...
    {
        MouseDownCustom?.Invoke(this, e);
        InvalidateSurface();
    }

    private void OnPointerReleased(object? sender, PointerEventArgs e)
    {
        MouseUpCustom?.Invoke(this, e);
        InvalidateSurface();
    }
    ...
    public void PaintText(string text, float fontSize = 12f, bool isBold = false)
    {
        _currentText = text;
        _textSize = fontSize;
        _textBold = isBold;
